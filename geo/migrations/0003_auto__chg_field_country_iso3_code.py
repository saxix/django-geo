...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('geo_country', 'iso3_code', self.gf('django.db.models.fields.CharField')(default='AAA', max_length=3))

    def backwards(self, orm):

        # Changing field 'Country.iso3_code'
        db.alter_column('geo_country', 'iso3_code', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
